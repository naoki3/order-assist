...
export const translations = {
  ja: {
    ...
    'incoming.receivedQtyLabel': '実入荷数',
    ...
    'cycleCount.saveDraft': '下書き保存',
    'cycleCount.saving': '保存中...',
    'cycleCount.noLots': '在庫ロットがありません',
    'cycleCount.saved': '棚卸しを保存しました',
    'cycleCount.draftSaved': '下書きを保存しました。内容を確認して適用してください',
    'cycleCount.draftReview': '棚卸し下書き — 内容を確認して適用',
    'cycleCount.apply': '在庫に反映する',
    'cycleCount.applied': '棚卸しを在庫に反映しました',
    'cycleCount.discard': '下書きを破棄',
  ...
  en: {
    ...
    'incoming.received': 'Received (Last 20 days)',
    ...
    'incoming.receivedQtyLabel': 'Actual recv qty',
    ...
    'cycleCount.saveDraft': 'Save Draft',
    'cycleCount.saving': 'Saving...',
    'cycleCount.noLots': 'No lots in stock',
    'cycleCount.saved': 'Cycle count saved',
    'cycleCount.draftSaved': 'Draft saved. Review and apply to inventory.',
    'cycleCount.draftReview': 'Cycle Count Draft — Review before applying',
    'cycleCount.apply': 'Apply to Inventory',
    'cycleCount.applied': 'Cycle count applied to inventory',
    'cycleCount.discard': 'Discard Draft',
