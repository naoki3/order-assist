-- Update fn_receive_receipt_line to accept optional status params (default: 良品)
...
-- Backfill: set 良品 on lots that have no status
UPDATE lots l
SET status_name  = '良品',
    status_color = 'green',
    status_id    = (SELECT id FROM inventory_statuses WHERE user_id = l.user_id AND name = '良品' LIMIT 1)
